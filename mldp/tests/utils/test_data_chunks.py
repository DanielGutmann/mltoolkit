import unittest
from mldp.tests.common import generate_data_chunk
from mldp.utils.errors import DataChunkError
from mldp.utils.tools.dc_writers import JsonWriter
from itertools import product
from mldp.utils.tools import DataChunk
from mlutils.helpers.paths_and_files import safe_mkdir, remove_dir
import os
import numpy as np
import json
...
class TestDataChunks(unittest.TestCase):
    ...
    def test_invalid_data_units_deletion(self):
        ...
        self.assertTrue([1, 2, 4] == dc['one'])
        self.assertTrue([10, 20, 40, 50, 60] == dc['two'])
