...
from mldp.steps.general import BaseGeneral
from mldp.steps.preprocessors import BasePreProcessor
from mldp.steps.formatters.base_formatter import BaseFormatter
from mldp.steps.general.chunk_accumulator import ChunkAccumulator
from mldp.utils.constants.dp import TERMINATION_TOKEN, EMPTY_CHUNK
from mldp.utils.errors import DataChunkError
from mldp.utils.helpers.validation import equal_to_constant
from mldp.utils.tools import DataChunk
from mlutils.helpers.multi_processing import create_gen_from_queue
from mlutils.tools import SignedObject
from mlutils.helpers.formatting.general import format_to_standard_msg_str,\
    format_title
import warnings
import logging
...
class Pipeline(SignedObject):
    ...
    def __init__(self, reader, preprocessor=None, worker_processes_num=0,
                 input_buffer_size=5, output_buffer_size=5,
