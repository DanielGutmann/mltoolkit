...
class UnitSampler(BaseChunkCollector):
    ...
    Optionally, resets the seed based on OS random bytes.
    """
    
    def __init__(self, id_fname, min_units=None, max_units=None,
                 sample_all=True, reseed=False):
        """
        ...
        :param sample_all: if set to True performs sampling of reviews until
                                ...
                                drops the rest.
        :param reseed: reseed every time reset is called based on OS random
                       numbers. Prevents problems associated with
                       multi-processing.
        """
