...
from mldp import Pipeline
from logging import getLogger
from mlutils.helpers.formatting.general import format_big_box, metrics_to_str
...
class BaseIDev(BaseInterface):
    ...
    def eval_on_intern_metrs(self, data_source, **kwargs):
        ...
        for i, batch in enumerate(self.val_data_pipeline.iter(**data_source), 1):
